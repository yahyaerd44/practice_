...
public class C03_Ortalama {
    public static void main(String[] args) {
        ...
        //ve bu veriable a yazdıgımız 5 sayının toplamını assign edelim(atayalım)

        double toplam = num1 + num2 + num3 + num4 + num5;// sayısal (numeric) datalarda + isareti matematiksel toplama islemi yapar.
